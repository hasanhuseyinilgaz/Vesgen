      ...
      <div className="flex flex-col h-full bg-transparent overflow-hidden w-full">
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden px-6 pb-6 custom-scrollbar min-h-0 min-w-0">
          {activeTab === "indexes" && (
            <div className="flex flex-col gap-6 w-full">
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                <div
                  className="lg:col-span-4 glass-card p-5 rounded-xl border-border/50 shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4"
                >
                ...
                <div className="lg:col-span-1 glass-card p-5 rounded-xl border border-border/50 shadow-sm flex flex-col justify-center gap-3">
                ...
                <Card className="border-border/50 shadow-sm overflow-hidden glass-card">
                  <CardContent className="p-0">
                    <table className="w-full text-sm text-left">
                      <thead className="bg-card/95 border-b backdrop-blur-sm">
                        <tr>
                        ...
                        {indexes.map((idx) => {
                          ...
                          return (
                            <tr
                              key={uniqueId}
                              className={cn(
                                "transition-colors table-row-solid"
                              )}
                            >
          ...
          {activeTab === "logs" && (
            <div className="flex flex-col gap-6 w-full">
              <div
                className="flex flex-col sm:flex-row justify-between items-start sm:items-center glass-card p-5 rounded-xl border border-border/50 shadow-sm gap-4"
              >
                <div className="space-y-1">
                  <h3 className="font-semibold flex items-center text-lg">
                    <ActionTooltip
              ...
              {loadingDisk ? (
                ...
                dbFiles.length > 0 && (
                  <div className="flex flex-col gap-6 w-full">
                      ...
                      {dbFiles.map((file) => {
                        ...
                        return (
                          <Card
                            ...
                            className="border-border/50 shadow-sm glass-card transition-all hover:shadow-md"
                          >
                    ...
                    <Card
                      className="border-border/50 shadow-sm overflow-hidden flex flex-col w-full glass-card"
                    >
                        ...
                        <table className="w-full text-sm text-left">
                          ...
                          <tbody className="divide-y divide-border/50">
                            {topTables.map((table, i) => (
                              <tr
                                key={i}
                                className="transition-colors table-row-solid"
                              >
          ...
          {activeTab === "stats" && (
            <div className="flex flex-col gap-6 w-full">
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                <div className="lg:col-span-4 glass-card p-5 rounded-xl border border-border/50 shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  <div className="space-y-1">
                    <h3 className="font-semibold flex items-center text-lg">
                      <ActionTooltip
